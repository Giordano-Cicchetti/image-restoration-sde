...
class GeneralDiffusion(SDE):
    ...
    def reverse_sde(self, xt, T=-1, save_states=False, save_dir='sde_state', **kwargs):
        ...
        for t in tqdm(reversed(range(1, T + 1))):
            ...
            x_t_tilde = (1-alpha_t) * score + alpha_t * xt
            x_t_minus_one_tilde = (1-alpha_t_minus_one) * score + alpha_t_minus_one * xt

            x = x - x_t_tilde + x_t_minus_one_tilde
            # x = self.reverse_sde_step(x, score, t)
    ...
    # sample states for training
    def generate_random_states(self, x0, xT):
        ...
        #Determine noisy states
        noisy_states= ((1-alpha) * x0 ) + (alpha * xT)
